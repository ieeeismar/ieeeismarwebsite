...
<div class="steering-container">
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Wolfgang Broll.jpg' | relative_url }}" />
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Tobias Höllerer.jpg' | relative_url }}" />
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Barrett Ens.jpg' | relative_url }}" />
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Frank Guan.jpg' | relative_url }}" />
        <p class="name">Frank Guan</p>
        <div class="member-info">
            <p class="role">Sponsorship Officer</p>
            <p class="affiliation">Singapore Institute of Technology, Singapore</p>
            <p><a href="mailto:sponsorship.steering@ismar.net">sponsorship.steering@ismar.net</a></p>
        </div>
    </div>
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Kiyoshi Kiyokawa.webp' | relative_url }}" />
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Stephan Lukosch.webp' | relative_url }}" />
        <p class="name">Stephan Lukosch</p>
        <div class="member-info">
            <p class="role">Conference Coordination Officer</p>
            <p class="affiliation">HIT Lab NZ, University of Canterbury, New Zealand</p>
            <p><a href="mailto:conference_coordination.steering@ismar.net">conference_coordination.steering@ismar.net</a></p>
        </div>
    </div>
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Ulrich Eck.jpg' | relative_url }}" />
    ...
    <div class="steering-member">
        <img src="{{ 'assets/2026/img/Committee Members Images/Stefanie Zollmann.webp' | relative_url }}" />
        <p class="name">Stefanie Zollmann</p>
        <div class="member-info">
            <p class="role">Communications Officer</p>
            <p class="affiliation">Aarhus University, Denmark</p>
   ...
   <div class="steering-category">
    ...
    <div class="steering">
        <div class="steering-member">
            ...
            <div class="steering-member">
                <p class="name">Didier Stricker</p>
            </div>
            <div class="steering-member">
                <p class="name">J. Edward Swan II</p>
            </div>
            <div class="steering-member">
                <p class="name">Haruo Takemura</p>
            </div>
            <div class="steering-member">
                <p class="name">Hideyuki Tamura</p>
            </div>
            <div class="steering-member">
                <p class="name">Bruce Thomas</p>
            </div>
            <div class="steering-member">
                <p class="name">Greg Welch</p>
            </div>
            <div class="steering-member">
                <p class="name">Sean White</p>
            </div>
            <div class="steering-member">
                <p class="name">Martin Wiedmer</p>
            </div>
            <div class="steering-member">
                <p class="name">Hiroyuki Yamamoto</p>
            </div>
            <div class="steering-member">
                <p class="name">Naokazu Yokoya</p>
            </div>    
