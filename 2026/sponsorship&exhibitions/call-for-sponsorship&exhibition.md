...
## What is ISMAR?
IEEE International Symposium on Mixed and Augmented Reality (ISMAR) is a flagship conference (CORE 2021 A* rating) that explores the advances in research and commercial activities related to AR, MR, and Virtual Reality (VR). ISMAR is setting new standards and trends with wide-ranging, creative, innovative, and highly technical content (see example 2025 program at <a href="https://www.ieeeismar.net/2025/program/overview/">ISMAR 2025 Program Overview</a>)
...
| **Exhibition Space** | Large table, Early priority moving | Large table near diamond | Large table | Stand | Stand |  |
| **Complimentary Exhibition Booth (3m*3m)** | 10 | 5 | 3 | 2 | 1 |  |
| **Full Registration** | 8 | 6 | 4 | 3 | 2 |  |
| **Discount on additional registration** | 30 percent | 25 percent | 20 percent |  |  |  |
...
## Booth information
Booth design is subject to change based on venue conditions and organizer discretion.

<div class="content">
    <img class="sponsorship-img" id="sponsorship-img" src="{{ '/assets/2026/img/sponsorship/booth.png' | relative_url }}" style="width:100%; height:auto;" alt="Booth Image">
</div>


| **Dimensions**| 3m (L) x 3m (W) x 2.5m (H), Aluminum System Booth |
| **Signboard** | Placed on upper part of board with company name |
| **Furniture** | - 1 Information Desk (1m L x 0.5m W x 0.75m H)<br>- 2 Folding Chair |
| **Electricity** | 220V / 2 Socket |
