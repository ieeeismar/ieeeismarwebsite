---
layout: 2026/resources-page-2026
title: Video Presentation Guidelines
permalink: /2026/resources/video-presentation-guidelines/
---
...
- **Storage:** Upload the files to a cloud drive, such as Google Drive, Dropbox, or Mega, with public link access. Submit the links via PCS. Authors of non-PCS submissions (invited TVCG, invited ICGA) are asked to contact the organizers or chairs of their track regarding video sharing. **NOTE:** Do not use YouTube. 
...
- **Compliance:** All content used must be royalty-free and adhere to ISMAR26 [Code of Conduct](/2026/code-of-conduct/).
- **Storage:** Upload the files to a cloud drive, such as Google Drive, Dropbox, or Mega, with public link access. Submit the links via PCS. Authors of non-PCS submissions (i.e., workshops, workshop papers, tutorials, etc.) are asked to contact the organizers or chairs of their track regarding video sharing. **NOTE:** Do not use YouTube. 
- **Naming convention:** `tag_paper-id_session_teaservideo` (If the session name is not available at the time of teaser video submission, replace it with "_NA_" )
- **Contribution tags:**
  - CP (accepted as conference paper)
  - JP (accepted as journal paper)
  - ITVCG (invited TVCG paper)
...
All videos will be manually reviewed according to the [Code of Conduct](/2026/code-of-conduct/).