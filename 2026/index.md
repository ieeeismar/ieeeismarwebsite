...
<div class="hero">
    ...
    <div class="content">
        <img class="hero-logo" id="hero-logo" src="{{ '/assets/2026/img/hero.gif' | relative_url }}"
...
<script>
    window.onload = function() {
        // Define the path to the static image (processed server-side)
        var staticImagePath = "{{ '/assets/2026/img/static.png' | relative_url }}";
        
        // Get the image element by its ID
        var heroLogo = document.getElementById("hero-logo");

        // Set a timeout to replace the GIF with the static PNG after 9.6 seconds
        setTimeout(function() {
            heroLogo.src = staticImagePath;
        }, 9500); // 9600 milliseconds = 9.6 seconds
    };
</script>
...
<section class="important-dates-section">
    ...
    <table class="important-dates">
        ...
        <tbody>
            <tr>
                <td><b>Abstract Deadline</b></td>
                <td><b>April 4th, 2026 (23:59 AoE, Friday)</b></td>
            </tr>
            <tr>
                <td><b>Paper Submission</b></td>
                <td><b>April 11th, 2026 (23:59 AoE, Friday)</b></td>
            </tr>
            <tr>
                <td><b>Initial Notification</b></td>
                <td><b>June 3rd, 2026 (23:59 AoE, Tuesday)</b></td>
            </tr>
            <tr>
                <td><b>Revise and Resubmit</b></td>
                <td><b>June 18th, 2026 (23:59 AoE, Wednesday)</b></td>
            </tr>
            <tr>
                <td><b>Final Notification</b></td>
                <td>
                    <b>
                        July 22nd, 2026 (23:59 AoE, Tuesday)<br>
                        July 25th, 2026 (23:59 AoE, Friday)
                    </b>
                </td>
            </tr>
            <tr>
                <td><b>Camera-ready Version</b></td>
                <td>
                    <b>
                        July 31st, 2026 (23:59 AoE, Thursday)<br>
                        August 3rd, 2026 (23:59 AoE, Sunday)
                    </b>
                </td>
            </tr>
        </tbody>
    ...
    <div class="download-calendar">
        <a href="/2026/contribute/paper-deadlines.ics" download class="calendar-button">
